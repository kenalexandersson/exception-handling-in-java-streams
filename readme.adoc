...
image:http://www.plantuml.com/plantuml/proxy?src=https://github.com/kenalexandersson/exception-handling-in-java-streams/tree/master/src/main/resources/plantuml/class-either.puml?cache=no[]
